<?php
  ...
  $conn_id = myConnect()
    ...
    <div class = "title">
      <h1>Which property do you want to Update?<h1>
    </div>

    <div class ="input">
      <form name = "form" method="GET" action="property-update-details.php">
      Select property number to Update: <select name="pno">
        <?php
